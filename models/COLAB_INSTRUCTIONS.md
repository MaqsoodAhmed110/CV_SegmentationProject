...
2. Upload the `segmentation.ipynb` file (located in your local `models/` folder) to the Colab files section.
...
5. The final p evaluation metrics (mAP, IoU) are drafted in the`TRAINING_REPORT.md`!
